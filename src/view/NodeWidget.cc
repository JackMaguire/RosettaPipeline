...
{
  addWidget( Wt::cpp14::make_unique< Wt::WText >( "Node functionality works but is still ugly." ) );
  addWidget( Wt::cpp14::make_unique< Wt::WBreak >() );
  addWidget( Wt::cpp14::make_unique< Wt::WText >( "EVERY time you want to save, you need to hit the \"Node\"" ) );
  addWidget( Wt::cpp14::make_unique< Wt::WBreak >() );
  ...
  Wt::WPushButton * downloadButton = addWidget( Wt::cpp14::make_unique< Wt::WPushButton >( "Node" ) );
