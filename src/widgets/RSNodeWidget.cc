...
void
RSNodeWidget::construct_segment1(
  GraphWidget * const graph_widget,
...
void
RSNodeWidget::construct_segment2(
...
void
RSNodeWidget::construct_segment3(
  Wt::WVBoxLayout & outer_layout
){
  Wt::WContainerWidget * const container =
    outer_layout.addWidget( Wt::cpp14::make_unique< Wt::WContainerWidget >() );
...
void
RSNodeWidget::construct_segment4 (
  Wt::WVBoxLayout & outer_layout
){
  Wt::WContainerWidget * const container =
    outer_layout.addWidget( Wt::cpp14::make_unique< Wt::WContainerWidget >() );
...
void
RSNodeWidget::construct_segment5 (
...
void
RSNodeWidget::updateDefaultCommand( std::string const & new_command ) {
  if( node_->useDefaultCommand() ){
