...
ExtraFileDialog.o: src/widgets/ExtraFileDialog.cc
	${CXX} -c -o build/ExtraFileDialog.o src/widgets/ExtraFileDialog.cc ${GEN} ${WT_FLAGS}
...
widgets: GraphWidget.o GraphToolbarWidget.o NodeWidget.o EdgeWidget.o TopWidget.o LeftViewWidget.o RightViewWidget.o CompileWidget.o ExtraFileDialog.o\
	...
	ld -r build/GraphWidget.o build/GraphToolbarWidget.o build/TopWidget.o build/RightViewWidget.o build/LeftViewWidget.o\
		build/ExtraFileWidget.o build/PublicationBrowserDialog.o build/ExtraFileDialog.o\
